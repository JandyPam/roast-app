...
<style lang="scss">
    ...
    input[type="text"].new-tag-input:focus {
        box-shadow: none;
    }
    input[type="text"].new-tag-input.duplicate-warning {
        color: red;
    }
    ...
    div.tag-search-result:hover {
        background-color: #ccc;
    }
    div.tag-search-result.selected-search-index {
        background-color: #ccc;
    }
</style>